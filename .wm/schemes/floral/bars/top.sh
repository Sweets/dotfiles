...
getws(){
    ...
    currentws=`sh /users/grace/.wm/schemes/floral/bars/await.sh $file "xprop -root | grep '_NET_CURRENT_DESKTOP(CARDINAL)'"`
...
volume(){
    ...
    vol=`sh /users/grace/.wm/schemes/floral/bars/await.sh $file "amixer get Master"`
